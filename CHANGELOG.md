...
- **Credentials Separation**: Separated database connection configuration into an external `config.php` file (git-ignored for security) and provided `config.example.php` template to prevent accidental credential leakage.
