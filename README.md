...
MeetFlow ระบบปฏิทินบันทึกนัดประชุมและอบรมสำหรับผู้บริหารบน Windows Server (IIS+PHP+MySQL/SQLite) สวยงามด้วยดีไซน์กระจกฝ้าโปร่งแสง ทำงานเชื่อมโยงคอมพิวเตอร์และมือถือผ่านการสแกน QR Code ถ่ายรูปส่งตรงเข้าฟอร์ม ค้นหาเอกสารเชิญรวดเร็วผ่าน LINE LIFF แจ้งเตือนวาระงานเข้า Discord และมีแผงระบบล้างไฟล์เก่า/ไฟล์ขยะช่วยประหยัดความจุเซิร์ฟเวอร์
...
├── config.php             # ไฟล์เก็บข้อมูลเชื่อมต่อฐานข้อมูลสำหรับเซิร์ฟเวอร์หลัก (git-ignored)
├── config.example.php     # ไฟล์ตัวอย่างตั้งค่าฐานข้อมูลเพื่อให้นำไปคัดลอกใช้งาน
...
├── settings.php           # หน้าตั้งค่า Discord Webhook, รหัสผ่าน และการล้างข้อมูลพื้นที่จัดเก็บ (Admin)
├── cleanup_attachments.php# API ล้างไฟล์แนบประวัติเก่าและสแกนลบไฟล์ขยะตกค้างจากเครื่อง
├── generate_upload_token.php # API สร้างเซสชัน QR Code สำหรับถ่ายอัปโหลดผ่านมือถือชั่วคราว
├── check_temp_upload.php  # API ตรวจสอบสถานะการอัปโหลดไฟล์/สแกนลิงก์จากโทรศัพท์มือถือ
├── save_mobile_upload.php # API บันทึกไฟล์ภาพ/เอกสารอัปโหลดจากอุปกรณ์เคลื่อนที่
├── save_scanned_link.php  # API บันทึกลิงก์และรีเซ็ตค่าจากการสแกนกล้องมือถือ
├── mobile_scan_link.php   # หน้าเว็บสแกนเนอร์กล้องสดบนมือถือสำหรับอ่าน QR Code ลิงก์เข้าฟอร์ม (พร้อมปุ่มสแกนใหม่)
├── mobile_upload.php      # หน้าเว็บอัปโหลดรูปภาพ/เอกสารผ่านมือถือ
